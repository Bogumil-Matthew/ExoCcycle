...
def calculateBathymetryDistributionBasin(bathymetry, latitudes, longitudes, basinIDA, highlatlat, areaWeights, binEdges=None, fldName=os.getcwd(), verbose=True):
    """
