...
There are jupiter notebooks within the JN folder. After dowloading/cloning this library, open the GMD_Manuscript_Figures.ipynb to see example of how this library can be used.
